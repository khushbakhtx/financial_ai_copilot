...
const TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  upload_train: "Uploading data",
  configure_preprocessing: "Confirm Configuration",
  preprocess_train: "Preprocessing",
  run_code: "Coding",
  get_features: "Grabbing features",
  get_train_info: "Checking dataset info",
  run_code_and_upload: "Working on Dataset itself",
};
...
export const ToolCallBox = React.memo<ToolCallBoxProps>(
  ({
    ...
    const { name, args, result, status } = useMemo(() => {
      return {
        name: TOOL_DISPLAY_NAMES[toolCall.name] ?? toolCall.name ?? "Unknown Tool",
        args: toolCall.args || {},
